    ...
    <form action="{{ route('posts.update', $post) }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <textarea name="body" rows="10"
                class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent">{{ old('body', $post->body) }}</textarea>
        </div>
